...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__twitter_service__ = __webpack_require__("./src/app/twitter.service.ts");
...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            ...
            providers: [__WEBPACK_IMPORTED_MODULE_1__twitter_service__["a" /* TwitterService */]]
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__twitter_service__["a" /* TwitterService */]])
    ], AppComponent);
    return AppComponent;
}());
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__tweet_tweet_component__ = __webpack_require__("./src/app/tweet/tweet.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__tweets_tweets_component__ = __webpack_require__("./src/app/tweets/tweets.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_8__tweets_tweets_component__["a" /* TweetsComponent */]
            ],
            imports: [
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__tweet__ = __webpack_require__("./src/app/tweet.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var TweetComponent = /** @class */ (function () {
    ...
    __decorate([
        ...
        __metadata("design:type", __WEBPACK_IMPORTED_MODULE_1__tweet__["a" /* Tweet */])
    ...
    TweetComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            ...
            styles: [__webpack_require__("./src/app/tweet/tweet.component.scss")]
        })
    ], TweetComponent);
...
var TweetsComponent = /** @class */ (function () {
    ...
    TweetsComponent.prototype.logText = function (searchKey) {
        this.since = searchKey;
        this.since = this.since.replace(/#/g, "%23");
        this.getTweets();
    };
    TweetsComponent.prototype.onCountSelect = function (event) {
    ...
    TweetsComponent.prototype.getTweets = function () {
        ...
        this.twitter.home(this.since, this.curCount).subscribe(function (tweets) {
            try {
                tweets.data.statuses.forEach(function (tweet) {
    ...
    TweetsComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            ...
            styles: [__webpack_require__("./src/app/tweets/tweets.component.scss")]
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__twitter_service__["a" /* TwitterService */]])
    ], TweetsComponent);
...
var TwitterService = /** @class */ (function () {
    ...
    TwitterService.prototype.user = function () {
        return this.http.get(__WEBPACK_IMPORTED_MODULE_2__environments_environment__["a" /* environment */].api + "/user");
    };
    TwitterService.prototype.home = function (since, curCount) {
        return this.http.get(__WEBPACK_IMPORTED_MODULE_2__environments_environment__["a" /* environment */].api + "/home?since=" + since + "&count=" + curCount);
    };
